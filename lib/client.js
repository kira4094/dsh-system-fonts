...
//
// Registers a Settings → General picker (same slot dsh-fonts uses) that lets
// you pick any locally-installed font for the UI font (--dsw-font-family) and
// the code font (--ds-font-family-code). The font list is fetched from the
// host endpoint /plugins/dsh-system-fonts/fonts. Choices apply immediately via
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const defaultPrefs = {
      ...
      code: 'Maple Mono NF CN' // sensible code default, user can change
    }
